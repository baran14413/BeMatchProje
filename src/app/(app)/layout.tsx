...
import { MessageCircle, Shuffle, User, Zap } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="flex flex-1">
        <nav className="hidden md:fixed md:left-0 md:top-16 md:flex md:h-[calc(100vh-4rem)] md:w-20 md:flex-col md:items-center md:justify-between md:border-r md:py-6 md:bg-background">
