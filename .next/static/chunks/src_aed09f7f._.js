...
"[project]/src/app/(app)/tag/[tag]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
                ...
                "TagPage.useEffect.fetchPostsByTag": async ()=>{
                    ...
                    try {
                        ...
                        const postsData = await Promise.all(querySnapshot.docs.map({
                            "TagPage.useEffect.fetchPostsByTag": async (postDoc)=>{
                        ...
                        }["TagPage.useEffect.fetchPostsByTag"]));
                        setPosts(postsData.filter({
                            "TagPage.useEffect.fetchPostsByTag": (p)=>p !== null
                        }["TagPage.useEffect.fetchPostsByTag"]));
                    } catch (error) {
...
_s(TagPage, "oS64e1sHBTZ4LE2vUKjCfTz+PKE=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "TagPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_aed09f7f._.js.map