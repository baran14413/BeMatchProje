...
"[project]/src/ai/flows/data:beaf62 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
const AppLockScreen = ({ onUnlock })=>{
    ...
    const handleBiometricAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppLockScreen.useCallback[handleBiometricAuth]": async ()=>{
            try {
    ...
    }["AppLockScreen.useCallback[handleBiometricAuth]"], [
        onUnlock,
        toast
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(AppLockScreen, "Hq8OkWlcNM1U0w/WYPtdY0lbJTU=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$beaf62__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:beaf62 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/framer-motion/dist/es/render/components/motion/proxy.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/framer-motion/dist/es/components/AnimatePresence/index.mjs [app-client] (ecmascript)");
...
const HeartExplosion = ({ isExploding })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
        children: isExploding && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function LayoutContent({ children }) {
    ...
    const [lastNotification, setLastNotification] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const lastShownNotificationIdRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const notificationTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
                                ...
                                if (userDocSnap.exists()) {
                                    ...
                                    if (!sessionStorage.getItem('welcomeMessageShown')) {
                                        ...
                                        notificationTimeoutRef.current = setTimeout({
                                            "LayoutContent.useEffect.unsubscribeAuth": ()=>setShowNotification(false)
                                        }["LayoutContent.useEffect.unsubscribeAuth"], 6000);
                                        sessionStorage.setItem('welcomeMessageShown', 'true');
                                    }
                                    if (!activityLoggedRef.current && profileData.name && profileData.avatarUrl) {
                                        fetch('https://api.ipify.org?format=json').then({
                                            "LayoutContent.useEffect.unsubscribeAuth": (res)=>res.json()
                                        }["LayoutContent.useEffect.unsubscribeAuth"]).then({
                                            "LayoutContent.useEffect.unsubscribeAuth": (data)=>{
                                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$beaf62__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["logActivity"])({
                                                    userId: user.uid,
                                        ...
                                        }["LayoutContent.useEffect.unsubscribeAuth"]).catch({
                                            "LayoutContent.useEffect.unsubscribeAuth": (err)=>console.error("Could not fetch IP for logging:", err)
                ...
                "LayoutContent.useEffect.unsubscribeNotifications": async (snapshot)=>{
                    if (!snapshot.empty) {
                        ...
                        if (newNotifId !== lastShownNotificationIdRef.current) {
                            ...
                            const notifRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'notifications', newNotifId);
                            ...
                            if (notificationTimeoutRef.current) clearTimeout(notificationTimeoutRef.current);
                            notificationTimeoutRef.current = setTimeout({
                                "LayoutContent.useEffect.unsubscribeNotifications": ()=>{
                                    setShowNotification(false);
                                }
                            }["LayoutContent.useEffect.unsubscribeNotifications"], 4000);
                        }
                    }
                }
            }["LayoutContent.useEffect.unsubscribeNotifications"], {
                "LayoutContent.useEffect.unsubscribeNotifications": (error)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HeartExplosion, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    showNavs && !isFullScreen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("fixed bottom-0 left-0 right-0 z-40 border-t border-border/50 bg-background/80 backdrop-blur-sm transition-transform duration-300 md:hidden", "h-[var(--bottom-nav-height)]", isScrolling && "translate-y-full"),
...
_s(LayoutContent, "4TDkDTTwIECzx4q0YJavogRHkzQ=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "HeartExplosion");
__turbopack_context__.k.register(_c2, "LayoutContent");
...
//# sourceMappingURL=src_10d23f05._.js.map