...
function BlockedAccountsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BlockedAccountsPage.useEffect": ()=>{
            const fetchBlockedUsers = {
                "BlockedAccountsPage.useEffect.fetchBlockedUsers": async ()=>{
                    if (!currentUser) {
                        setLoading(false);
                        return;
                    }
                    try {
                        ...
                        if (userDoc.exists()) {
                            ...
                            if (blockedIds.length > 0) {
                                const blockedUserPromises = blockedIds.map({
                                    "BlockedAccountsPage.useEffect.fetchBlockedUsers.blockedUserPromises": (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', id))
                                }["BlockedAccountsPage.useEffect.fetchBlockedUsers.blockedUserPromises"]);
                                const blockedUserDocs = await Promise.all(blockedUserPromises);
                                const users = blockedUserDocs.filter({
                                    "BlockedAccountsPage.useEffect.fetchBlockedUsers.users": (doc)=>doc.exists()
                                }["BlockedAccountsPage.useEffect.fetchBlockedUsers.users"]).map({
                                    "BlockedAccountsPage.useEffect.fetchBlockedUsers.users": (doc)=>({
                                            uid: doc.id,
                                            ...doc.data()
                                        })
                                }["BlockedAccountsPage.useEffect.fetchBlockedUsers.users"]);
                        ...
                        toast({
                            variant: 'destructive',
                            title: "Engellenen kullanıcılar alınamadı."
                        });
                    } finally{
                        setLoading(false);
                    }
                }
            }["BlockedAccountsPage.useEffect.fetchBlockedUsers"];
            fetchBlockedUsers();
        }
    }["BlockedAccountsPage.useEffect"], [
        currentUser,
    ...
    const unblockUser = async (userIdToUnblock)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(userDocRef, {
                blockedUsers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arrayRemove"])(userIdToUnblock)
            });
            ...
            toast({
                variant: 'destructive',
                title: "Engelleme kaldırılırken bir hata oluştu."
            });
        }
    };
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 82,
                    columnNumber: 21
                }, this) : blockedUsers.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-4",
...
_s(BlockedAccountsPage, "RnJdiW/Qunzd0bSqrgC65aSmn1M=", false, function() {
    return [
...
//# sourceMappingURL=_f90677ef._.js.map