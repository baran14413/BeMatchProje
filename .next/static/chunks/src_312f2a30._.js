...
"[project]/src/app/(app)/location/[location]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
            ...
            const fetchPostsByLocation = {
                "LocationPage.useEffect.fetchPostsByLocation": async ()=>{
                    ...
                    try {
                        ...
                        const postsData = await Promise.all(querySnapshot.docs.map({
                            "LocationPage.useEffect.fetchPostsByLocation": async (postDoc)=>{
                        ...
                        }["LocationPage.useEffect.fetchPostsByLocation"]));
                        setPosts(postsData.filter({
                            "LocationPage.useEffect.fetchPostsByLocation": (p)=>p !== null
                        }["LocationPage.useEffect.fetchPostsByLocation"]));
                    } catch (error) {
...
_s(LocationPage, "oS64e1sHBTZ4LE2vUKjCfTz+PKE=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "LocationPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_312f2a30._.js.map