            ...
            const fetchData = {
                "AdminDashboardPage.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        setRecentUsers(usersSnapshot.docs.map({
                        ...
                        const postsWithUsers = await Promise.all(postsSnapshot.docs.map({
                            "AdminDashboardPage.useEffect.fetchData": async (postDoc)=>{
                                const postData = postDoc.data();
                                const userSnap = await getDoc((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "users", postData.authorId));
                                return {
                                    id: postDoc.id,
                                    ...postData,
                                    user: userSnap.data()
...
_s(AdminDashboardPage, "qN5v7AUCTNYPJEHHvfqniiit3H0=", false, function() {
    return [
...
//# sourceMappingURL=src_608c538a._.js.map